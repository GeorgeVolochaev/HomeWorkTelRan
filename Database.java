...
public class Database {
    ...
    void update(Employee employeeOld, Employee employeeNew){
        employeeMap.replace(employeeOld.getFullName(),employeeOld,employeeNew);
        positions.add(employeeNew.getPosition());
    }
